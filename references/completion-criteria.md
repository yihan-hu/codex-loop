...
- When Codex Loop itself was updated, the task produced a validated repository-neutral consumer `skill.zip` after source validation/review and after any explicitly requested publication. The package was returned as the terminal update artifact, and completion did not depend on any installation action.
