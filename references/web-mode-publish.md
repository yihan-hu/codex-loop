...
Do not respond to any of these by switching to Local mode, force-pushing without the exact trigger lease, reconstructing files through GitHub APIs, or lowering commit/tree equality to content similarity.
